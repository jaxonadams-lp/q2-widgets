"""
CCtransactionSummary Extension
"""
...
class CCtransactionSummaryHandler(Q2TectonServerRequestHandler):
    ...
    FRIENDLY_NAME = 'CCtransactionSummary'  # this will be used for end user facing references to this extension like Central and Menu items.
    ...
    CONFIG_FILE_NAME = 'CCtransactionSummary'  # configuration/CCtransactionSummary.py file must exist if REQUIRED_CONFIGURATIONS exist

    TECTON_URL = 'https://cdn1.onlineaccess1.com/cdn/base/tecton/v1.39.0/q2-tecton-sdk.js'
    ...
    def get(self, *args, **kwargs):
        ...
        """
        self.write("Hello World GET: From CCtransactionSummary")
    ...
    async def submit(self):
        ...
        template = self.get_template(
            'submit.html.jinja2',
            {
                'header': "CCtransactionSummary",
                'message': 'Hello World POST: From "CCtransactionSummary".<br>',
