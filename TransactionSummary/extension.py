...
class TransactionSummaryHandler(Q2TectonServerRequestHandler):
    ...
    FRIENDLY_NAME = 'TransactionSummary'  # this will be used for end user facing references to this extension like Central and Menu items.
    ...
    CONFIG_FILE_NAME = 'TransactionSummary'  # configuration/TransactionSummary.py file must exist if REQUIRED_CONFIGURATIONS exist
    ...
    def get(self, *args, **kwargs):
        ...
        """
        self.write("Hello World GET: From TransactionSummary")
    ...
    async def submit(self):
        ...
        template = self.get_template(
            'submit.html.jinja2',
            {
                'header': "TransactionSummary",
                'message': 'Hello World POST: From "TransactionSummary".<br>',
